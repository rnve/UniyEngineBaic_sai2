// VisualStudio : Ms 사에서 개발한 LDE (통합 개발 환경)

// 파란색 : 
// 키워드(예약어) 
// 미리 정의되어있는 단어
// 이미 문법용도로 사용되고 있기 때문에 식별용으로 개발작가 쓸 수 없다.
...
// 녹색 : 
// 주석, 컴파일시 반영되지 않음. (컴파일 : 프로글애밍언어를 다른 언어ex) 어샘블리어 , 기계어 로 변환하는 과정)

// using 키워드 : 
// 특정 namespace 를 사용하기 위한 키워드
// ex) system 이라는 naespace 를 사용하겠다
//using System;
